pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE    = 'jokeped/fastapi-webhook:latest' // Ensure this Docker image name is correct and accessible.
        REMOTE_HOST     = 'blackhole_0323@35.247.190.211' // Replace with your actual username and remote IP.
